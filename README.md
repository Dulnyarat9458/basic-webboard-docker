# basic-webboard-backend
docker compose file to run basic webboard project.
...
3.run "docker compose up -d " in root of 3 repository. (you must have docker , docker-compose)<br> 
